...
onResult: function (result) {
    ...
    //this is called for every arabic id scan result
    //the result is a json-object containing all the scaned values and check-digits
    console.log("Arabic Id result: " + JSON.stringify(result));
...
onError: function (error) {
    ...
    if (error == "Canceled") {
        ...
        console.log("Arabic Id scanning canceled");
        return;
    }
...
scan: function () {
    ...
    cordova.exec(this.onResult, this.onError, "AnylineSDK", "scan", [licenseKey, this.anylineArabicIdViewConfig]);
}
};
