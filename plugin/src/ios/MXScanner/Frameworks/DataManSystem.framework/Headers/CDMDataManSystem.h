...
/*! \mainpage Cognex DataMan iOS SDK

\section intro_sec Introduction

The DataMan SDK can be used to connect to DataMan systems and perform operations on these systems. You can retrieve read results, images, image graphics and read statistics. The SDK also allows you to configure your system or change individual settings. Refer to the DMCC Command Reference document for a complete list of DMCC commands that you can send to a DataMan system.
...
The DataMan SDK comprises the iOS SDK lib files and their documentation. The library files are available for iOS 7.1.
...
/**
 *  Specifies the preview/trigger mode when using the Device Camera.
 */
...
/**
 *  Specifies the preview options when using the Device Camera.
 */
